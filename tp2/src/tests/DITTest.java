...
public class DITTest {
	...
	public void setUp() throws Exception {
		try {
			...
			List<String> content = FileReader.getFileContent("./tests/EquipeTestDIT.ucd");
		...
		} catch (IOException e) { fail("./tests/EquipeTestDIT.ucd inexistant -> Cannot test");
		} catch (UmlParsingError e) { 
			e.printStackTrace();
			fail("Error parsing valid file EquipeTestDIT.ucd"); }
	}
