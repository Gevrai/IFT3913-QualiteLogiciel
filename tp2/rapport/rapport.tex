...
\begin{document}
  ...
  Lors de l'implémentation des métriques DIT,CLD et NOD, nous nous sommes heurté à
  ...
  généralisation. Lorsqu'il détecte cette boucle de généralisation, il va mettre
  ces trois métriques à -1 pour signifié qu'il y a un problème dans notre graphe
  UCD.
